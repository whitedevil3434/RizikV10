...
async function migrate() {
    console.log('🚀 Starting migration (PG Direct)...');
    try {
        ...
        // 3. Add foreign key safely (using a DO block for manual check)
        ...
        // 4. Trigger for automatic user_usage creation
        console.log('Creating trigger for user_usage...');
        await client.query(`
