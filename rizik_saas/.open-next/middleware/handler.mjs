...
var require_middleware = __commonJS({
  ".next/server/src/middleware.js"() {
    "use strict";
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[550], { 5521: (e) => {
      "use strict";
      ...
      var I = new function e3(t2) {
        ...
        return q(t2, e3), t2;
      }(H), F = new M(), G = new D(), X = new B(), K = new $(), Q = new U(), Z = new z(), Y = new V(), J = new W();
      function ee() {
        return F;
      }
      !function(e3) {
      ...
      var eL = "[_0-9a-z-*/]", eq = RegExp("^(?:[a-z]" + eL + "{0,255}|" + ("[a-z0-9]" + eL) + "{0,240}@[a-z]" + eL + "{0,13})$"), eM = /^[ -~]{0,255}[!-~]$/, ej = /,|=/, eD = function() {
        function e3(e4) {
        ...
        return e3.prototype.set = function(e4, t2) {
          ...
          !(e4.length > 512) && (this._internalState = e4.split(",").reverse().reduce(function(e5, t2) {
            ...
            if (-1 !== n2) {
              ...
              eq.test(i2) && eM.test(o2) && !ej.test(o2) && e5.set(i2, o2);
            }
            return e5;
      ...
      (() => {
        var i = { 226: function(i2, o2) {
          !function(a2, s2) {
            "use strict";
            var l = "function", u = "undefined", c = "object", d = "string", p = "major", h = "model", f = "name", g = "type", v = "vendor", m = "version", w = "architecture", b = "console", y = "mobile", _ = "tablet", x = "smarttv", S = "wearable", C = "embedded", R = "Amazon", E = "Apple", k = "ASUS", T = "BlackBerry", P = "Browser", N = "Chrome", O = "Firefox", I = "Google", A = "Huawei", L = "Microsoft", q = "Motorola", M = "Opera", j = "Samsung", D = "Sharp", U = "Sony", B = "Xiaomi", $ = "Zebra", H = "Facebook", z = "Chromium OS", V = "Mac OS", W = function(e2, t2) {
              var r2 = {};
      ...
      let i = r(6152), o = { url: (e2) => e2.url, header: (e2, t2) => e2.headers.get(t2) };
      ...
      "use strict";
      let n;
      r.r(t), r.d(t, { default: () => e7 });
      var i = {};
      async function o() {
        return "_ENTRIES" in globalThis && _ENTRIES.middleware_instrumentation && await _ENTRIES.middleware_instrumentation;
      }
      r.r(i), r.d(i, { config: () => e5, middleware: () => e4 });
      let a = null;
      async function s() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let { context: em, propagation: ew, trace: eb, SpanStatusCode: ey, SpanKind: e_, ROOT_CONTEXT: ex } = n = r(8336);
      ...
      }, eR = /* @__PURE__ */ new Map(), eE = n.createContextKey("next.rootSpanId"), ek = 0, eT = () => ek++, eP = { set(e10, t2, r2) {
      ...
      class eN {
        ...
        trace(...e10) {
          ...
          if (!ef.includes(r2) && "1" !== process.env.NEXT_OTEL_VERBOSE || a2.hideSpan) return o2();
          let l2 = this.getSpanContext((null == a2 ? void 0 : a2.parentSpan) ?? this.getActiveScopeSpan()), u2 = false;
          l2 ? (null == (t2 = eb.getSpanContext(l2)) ? void 0 : t2.isRemote) && (u2 = true) : (l2 = (null == em ? void 0 : em.active()) ?? ex, u2 = true);
          let c2 = eT();
          return a2.attributes = { "next.span_name": s2, "next.span_type": r2, ...a2.attributes }, em.with(l2.setValue(eE, c2), () => this.getTracerInstance().startActiveSpan(s2, a2, (e11) => {
            let t3 = "performance" in globalThis && "measure" in performance ? globalThis.performance.now() : void 0, n3 = () => {
              eR.delete(c2), t3 && process.env.NEXT_OTEL_PERFORMANCE_PREFIX && eg.includes(r2 || "") && performance.measure(`${process.env.NEXT_OTEL_PERFORMANCE_PREFIX}:next-${(r2.split(".").pop() || "").replace(/[A-Z]/g, (e12) => "-" + e12.toLowerCase())}`, { start: t3, end: performance.now() });
            };
        ...
        wrap(...e10) {
          ...
          return ef.includes(r2) || "1" === process.env.NEXT_OTEL_VERBOSE ? function() {
            ...
            {
              let n3 = t2.getContext().bind(em.active(), a2);
        ...
        getRootSpanAttributes() {
          let e10 = em.active().getValue(eE);
          return eR.get(e10);
        }
        setRootSpanAttribute(e10, t2) {
          let r2 = em.active().getValue(eE), n2 = eR.get(r2);
          n2 && n2.set(e10, t2);
        }
      }
      let eO = (() => {
      ...
      class eA {
        constructor(e10, t2, r2, n2) {
          ...
          }(t2, e10).isOnDemandRevalidate, a2 = null == (i2 = r2.get(eI)) ? void 0 : i2.value;
        ...
        enable() {
          ...
          this._mutableCookies.set({ name: eI, value: this._previewModeId, httpOnly: true, sameSite: "none", secure: true, path: "/" });
        }
        disable() {
          this._mutableCookies.set({ name: eI, value: "", httpOnly: true, sameSite: "none", secure: true, path: "/", expires: /* @__PURE__ */ new Date(0) });
        }
      }
      function eL(e10, t2) {
      ...
      async function eB(e10, { revalidatedTags: t2, pendingRevalidates: r2, pendingRevalidateWrites: n2 }) {
        var i2;
        return Promise.all([null == (i2 = e10.incrementalCache) ? void 0 : i2.revalidateTag(t2), ...Object.values(r2), ...n2]);
      }
      let e$ = Error("Invariant: AsyncLocalStorage accessed in runtime where it is not available");
      class eH {
        disable() {
          throw e$;
        }
      ...
      let ez = "undefined" != typeof globalThis && globalThis.AsyncLocalStorage, eV = ez ? new ez() : new eH();
      class eW {
        constructor({ waitUntil: e10, onClose: t2, onTaskError: r2 }) {
          this.workUnitStores = /* @__PURE__ */ new Set(), this.waitUntil = e10, this.onClose = t2, this.onTaskError = r2, this.callbackQueue = new (eM())(), this.callbackQueue.pause();
        }
        after(e10) {
          if (ev(e10)) this.waitUntil || eF(), this.waitUntil(e10.catch((e11) => this.reportTaskError("promise", e11)));
        ...
        addCallback(e10) {
          ...
          let n2 = eV.getStore(), i2 = n2 ? n2.rootTaskSpawnPhase : null == r2 ? void 0 : r2.phase;
          this.runCallbacksOnClosePromise || (this.runCallbacksOnClosePromise = this.runCallbacksOnClose(), this.waitUntil(this.runCallbacksOnClosePromise));
          let o2 = (t2 = async () => {
            try {
              await eV.run({ rootTaskSpawnPhase: i2 }, () => e10());
            } catch (e11) {
              this.reportTaskError("function", e11);
            }
          }, ez ? ez.bind(t2) : eH.bind(t2));
        ...
        async runCallbacks() {
          ...
          let e10 = K.I.getStore();
          if (!e10) throw new ej("Missing workStore in AfterContext.runCallbacks");
        ...
        reportTaskError(e10, t2) {
          if (console.error("promise" === e10 ? "A promise passed to `after()` rejected:" : "An error occurred in a function passed to `after()`:", t2), this.onTaskError) try {
            ...
            console.error(new ej("`onTaskError` threw while handling an error thrown from an `after` task", { cause: e11 }));
          }
        }
      }
      function eF() {
      ...
      let eZ = { keys: (e10) => Array.from(e10.keys()), get: (e10, t2) => e10.get(t2) ?? void 0 }, eY = (e10, t2) => eO().withPropagatedContext(e10.headers, t2, eZ), eJ = false;
      async function e0(e10) {
        ...
        let p2 = new eQ({ page: e10.page, input: function(e11, t3) {
        ...
        if ((n2 = await eY(p2, () => {
          if ("/middleware" === e10.page || "/src/middleware" === e10.page) {
            let t3 = f2.waitUntil.bind(f2), r2 = new eG();
            return eO().trace(eh.execute, { spanName: `middleware ${p2.method} ${p2.nextUrl.pathname}`, attributes: { "http.target": p2.nextUrl.pathname, "http.method": p2.method } }, async () => {
              try {
                var n3, o3, a3, l3, u3, c2, d3;
                let h3 = eX(), g3 = (u3 = p2.nextUrl, c2 = void 0, d3 = (e11) => {
                  i2 = e11;
                  ...
                  return { type: "request", phase: e11, implicitTags: i3 ?? [], url: { pathname: n4.pathname, search: n4.search ?? "" }, get headers() {
                    ...
                    if (!d4.cookies) {
                      ...
                      eL(t4, e12), d4.cookies = Y.seal(e12);
                    }
                    return d4.cookies;
                  }, set cookies(value) {
                    d4.cookies = value;
                    ...
                    if (!d4.mutableCookies) {
                      let e12 = function(e13, t5) {
                        ...
                        return ee.wrap(r4, t5);
                      }(t4.headers, o4 || (r3 ? c3 : void 0));
                      eL(t4, e12), d4.mutableCookies = e12;
                    }
                      ...
                      let e12 = function(e13) {
                        let t5 = new Proxy(e13, { get(e14, r4, n5) {
                          switch (r4) {
                            case "delete":
                              return function(...r5) {
                                return et("cookies().delete"), e14.delete(...r5), t5;
                              };
                            case "set":
                              return function(...r5) {
                                return et("cookies().set"), e14.set(...r5), t5;
                              };
                            default:
                              return j.get(e14, r4, n5);
                          }
                        } });
                        return t5;
                      }(this.mutableCookies);
                    ...
                    return d4.draftMode || (d4.draftMode = new eA(s3, t4, this.cookies, this.mutableCookies)), d4.draftMode;
                  ...
                  let a4 = { isStaticGeneration: !r3.supportsDynamicResponse && !r3.isDraftMode && !r3.isServerAction, page: e11, fallbackRouteParams: t4, route: (o4 = e11.split("/").reduce((e12, t5, r4, n5) => t5 ? "(" === t5[0] && t5.endsWith(")") || "@" === t5[0] || ("page" === t5 || "route" === t5) && r4 === n5.length - 1 ? e12 : e12 + "/" + t5 : e12, "")).startsWith("/") ? o4 : "/" + o4, incrementalCache: r3.incrementalCache || globalThis.__incrementalCache, cacheLifeProfiles: r3.cacheLifeProfiles, isRevalidate: r3.isRevalidate, isPrerendering: r3.nextExport, fetchCache: r3.fetchCache, isOnDemandRevalidate: r3.isOnDemandRevalidate, isDraftMode: r3.isDraftMode, requestEndedState: n4, isPrefetchRequest: i3, buildId: r3.buildId, reactLoadableManifest: (null == r3 ? void 0 : r3.reactLoadableManifest) || {}, assetPrefix: (null == r3 ? void 0 : r3.assetPrefix) || "", afterContext: function(e12) {
                    ...
                    return new eW({ waitUntil: t5, onClose: r4, onTaskError: n5 });
                  }(r3) };
                ...
                return await K.I.run(v3, () => Q.e.run(g3, e10.handler, p2, f2));
              } finally {
                setTimeout(() => {
                  r2.dispatchClose();
                }, 0);
      ...
      r(5494), "undefined" == typeof URLPattern || URLPattern, r(3886).unstable_postpone;
      ...
      let e1 = ["/admin", "/portal"], e2 = ["/login", "/auth"];
      function e3(e10) {
        return e10.trim().toLowerCase();
      }
      function e4(e10) {
        let t2 = e10.nextUrl.pathname, r2 = e10.nextUrl.search, n2 = e1.some((e11) => t2.startsWith(e11)), i2 = process.env.OPS_HOSTNAME ? e3(process.env.OPS_HOSTNAME) : "", o2 = e3(e10.headers.get("host") || ""), a2 = !!i2 && o2.split(":")[0] === i2.split(":")[0];
        if (n2 && i2 && !a2) {
          let t3 = e10.nextUrl.clone();
          return t3.host = i2, $.redirect(t3);
        }
        if (i2 && a2 && !n2 && !e2.some((e11) => t2.startsWith(e11)) && "/account" !== t2) {
          let t3 = e10.nextUrl.clone();
          return t3.pathname = "/admin", t3.search = "", $.redirect(t3);
        }
        if (n2 && !e10.cookies.getAll().some((e11) => e11.name.includes("auth-token") && e11.name.startsWith("sb-"))) {
          let n3 = e10.nextUrl.clone();
          return n3.pathname = "/login", n3.search = `?next=${encodeURIComponent(`${t2}${r2}`)}`, $.redirect(n3);
        }
        return $.next();
      }
      let e5 = { matcher: ["/((?!api|_next/static|_next/image|favicon.ico|rizik-logo.svg|rizik-mark.svg).*)"] };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let e6 = { ...i }, e8 = e6.middleware || e6.default, e9 = "/src/middleware";
      if ("function" != typeof e8) throw Error(`The Middleware "${e9}" must export a \`middleware\` or a \`default\` function`);
      function e7(e10) {
        return e0({ ...e10, page: e9, handler: async (...e11) => {
          try {
            return await e8(...e11);
          } catch (i2) {
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "src/middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static|_next\\/image|favicon.ico|rizik-logo.svg|rizik-mark.svg).*))(\\.json)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": {}, "webpack": null, "eslint": { "ignoreDuringBuilds": false }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [], "unoptimized": false }, "devIndicators": { "appIsrStatus": true, "buildActivity": true, "buildActivityPosition": "bottom-right" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/Users/sabbir/RizikV10/rizik_saas", "experimental": { "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 0, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 9, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "turbo": { "root": "/Users/sabbir/RizikV10/rizik_saas" }, "typedRoutes": false, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "reactOwnerStack": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "useEarlyImport": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "dynamicIO": false, "inlineCss": false, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-squlite-node", "@effect/sql-squlite-bun", "@effect/sql-squlite-wasm", "@effect/sql-squlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts" };
var BuildId = "ptMePJ1Rhx4Ukp9MfQYp_";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/account", "regex": "^/account(?:/)?$", "routeKeys": {}, "namedRegex": "^/account(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/admin/analytics", "regex": "^/admin/analytics(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/analytics(?:/)?$" }, { "page": "/admin/crm", "regex": "^/admin/crm(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/crm(?:/)?$" }, { "page": "/admin/fair", "regex": "^/admin/fair(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/fair(?:/)?$" }, { "page": "/admin/inventory", "regex": "^/admin/inventory(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/inventory(?:/)?$" }, { "page": "/admin/orders", "regex": "^/admin/orders(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/orders(?:/)?$" }, { "page": "/admin/production", "regex": "^/admin/production(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/production(?:/)?$" }, { "page": "/admin/products", "regex": "^/admin/products(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/products(?:/)?$" }, { "page": "/admin/qr", "regex": "^/admin/qr(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/qr(?:/)?$" }, { "page": "/admin/squads", "regex": "^/admin/squads(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/squads(?:/)?$" }, { "page": "/admin/team", "regex": "^/admin/team(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/team(?:/)?$" }, { "page": "/auth/callback", "regex": "^/auth/callback(?:/)?$", "routeKeys": {}, "namedRegex": "^/auth/callback(?:/)?$" }, { "page": "/b2b", "regex": "^/b2b(?:/)?$", "routeKeys": {}, "namedRegex": "^/b2b(?:/)?$" }, { "page": "/bio-shield", "regex": "^/bio\\-shield(?:/)?$", "routeKeys": {}, "namedRegex": "^/bio\\-shield(?:/)?$" }, { "page": "/cart", "regex": "^/cart(?:/)?$", "routeKeys": {}, "namedRegex": "^/cart(?:/)?$" }, { "page": "/checkout", "regex": "^/checkout(?:/)?$", "routeKeys": {}, "namedRegex": "^/checkout(?:/)?$" }, { "page": "/community", "regex": "^/community(?:/)?$", "routeKeys": {}, "namedRegex": "^/community(?:/)?$" }, { "page": "/fair", "regex": "^/fair(?:/)?$", "routeKeys": {}, "namedRegex": "^/fair(?:/)?$" }, { "page": "/fair/dashboard", "regex": "^/fair/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/fair/dashboard(?:/)?$" }, { "page": "/fair/join", "regex": "^/fair/join(?:/)?$", "routeKeys": {}, "namedRegex": "^/fair/join(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/impact", "regex": "^/impact(?:/)?$", "routeKeys": {}, "namedRegex": "^/impact(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }, { "page": "/mats", "regex": "^/mats(?:/)?$", "routeKeys": {}, "namedRegex": "^/mats(?:/)?$" }, { "page": "/portal", "regex": "^/portal(?:/)?$", "routeKeys": {}, "namedRegex": "^/portal(?:/)?$" }, { "page": "/portal/knowledge", "regex": "^/portal/knowledge(?:/)?$", "routeKeys": {}, "namedRegex": "^/portal/knowledge(?:/)?$" }, { "page": "/portal/logistics", "regex": "^/portal/logistics(?:/)?$", "routeKeys": {}, "namedRegex": "^/portal/logistics(?:/)?$" }, { "page": "/portal/requests", "regex": "^/portal/requests(?:/)?$", "routeKeys": {}, "namedRegex": "^/portal/requests(?:/)?$" }, { "page": "/portal/tasks", "regex": "^/portal/tasks(?:/)?$", "routeKeys": {}, "namedRegex": "^/portal/tasks(?:/)?$" }, { "page": "/store", "regex": "^/store(?:/)?$", "routeKeys": {}, "namedRegex": "^/store(?:/)?$" }, { "page": "/subsidiaries", "regex": "^/subsidiaries(?:/)?$", "routeKeys": {}, "namedRegex": "^/subsidiaries(?:/)?$" }, { "page": "/trust", "regex": "^/trust(?:/)?$", "routeKeys": {}, "namedRegex": "^/trust(?:/)?$" }], "dynamic": [{ "page": "/store/[slug]", "regex": "^/store/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/store/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/verify/[code]", "regex": "^/verify/([^/]+?)(?:/)?$", "routeKeys": { "nxtPcode": "nxtPcode" }, "namedRegex": "^/verify/(?<nxtPcode>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "a73f14461f32143a34336ee6512fa976", "previewModeSigningKey": "5730c734290a78172c1781d25a4bc992283e1a2a9bcd3958bca45d8082df7eb5", "previewModeEncryptionKey": "bbfa7974c59a4eb46461271342202adc12a9341c1aef19e1070e5435808197d5" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static|_next\\/image|favicon.ico|rizik-logo.svg|rizik-mark.svg).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!api|_next/static|_next/image|favicon.ico|rizik-logo.svg|rizik-mark.svg).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "ptMePJ1Rhx4Ukp9MfQYp_", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "wny/CXl50KtPKMNyxJ3x5S/nqeUq7ZPkAMbGAD4rXHc=", "__NEXT_PREVIEW_MODE_ID": "a73f14461f32143a34336ee6512fa976", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "bbfa7974c59a4eb46461271342202adc12a9341c1aef19e1070e5435808197d5", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5730c734290a78172c1781d25a4bc992283e1a2a9bcd3958bca45d8082df7eb5" } } }, "functions": { "/auth/callback/route": { "files": ["server/server-reference-manifest.js", "server/app/auth/callback/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/438.js", "server/edge-chunks/656.js", "server/edge-chunks/276.js", "server/app/auth/callback/route.js"], "name": "app/auth/callback/route", "page": "/auth/callback/route", "matchers": [{ "regexp": "^/auth/callback$", "originalSource": "/auth/callback" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "ptMePJ1Rhx4Ukp9MfQYp_", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "wny/CXl50KtPKMNyxJ3x5S/nqeUq7ZPkAMbGAD4rXHc=", "__NEXT_PREVIEW_MODE_ID": "a73f14461f32143a34336ee6512fa976", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "bbfa7974c59a4eb46461271342202adc12a9341c1aef19e1070e5435808197d5", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5730c734290a78172c1781d25a4bc992283e1a2a9bcd3958bca45d8082df7eb5" } }, "/api/setup-db/route": { "files": ["server/server-reference-manifest.js", "server/app/api/setup-db/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/438.js", "server/edge-chunks/276.js", "server/app/api/setup-db/route.js"], "name": "app/api/setup-db/route", "page": "/api/setup-db/route", "matchers": [{ "regexp": "^/api/setup\\-db$", "originalSource": "/api/setup-db" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "ptMePJ1Rhx4Ukp9MfQYp_", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "wny/CXl50KtPKMNyxJ3x5S/nqeUq7ZPkAMbGAD4rXHc=", "__NEXT_PREVIEW_MODE_ID": "a73f14461f32143a34336ee6512fa976", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "bbfa7974c59a4eb46461271342202adc12a9341c1aef19e1070e5435808197d5", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5730c734290a78172c1781d25a4bc992283e1a2a9bcd3958bca45d8082df7eb5" } }, "/store/[slug]/page": { "files": ["server/server-reference-manifest.js", "server/app/store/[slug]/page_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/438.js", "server/edge-chunks/656.js", "server/edge-chunks/37.js", "server/edge-chunks/734.js", "server/app/store/[slug]/page.js"], "name": "app/store/[slug]/page", "page": "/store/[slug]/page", "matchers": [{ "regexp": "^/store/(?<slug>[^/]+?)$", "originalSource": "/store/[slug]" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "ptMePJ1Rhx4Ukp9MfQYp_", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "wny/CXl50KtPKMNyxJ3x5S/nqeUq7ZPkAMbGAD4rXHc=", "__NEXT_PREVIEW_MODE_ID": "a73f14461f32143a34336ee6512fa976", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "bbfa7974c59a4eb46461271342202adc12a9341c1aef19e1070e5435808197d5", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5730c734290a78172c1781d25a4bc992283e1a2a9bcd3958bca45d8082df7eb5" } }, "/store/page": { "files": ["server/server-reference-manifest.js", "server/app/store/page_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/438.js", "server/edge-chunks/656.js", "server/edge-chunks/37.js", "server/edge-chunks/734.js", "server/app/store/page.js"], "name": "app/store/page", "page": "/store/page", "matchers": [{ "regexp": "^/store$", "originalSource": "/store" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "ptMePJ1Rhx4Ukp9MfQYp_", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "wny/CXl50KtPKMNyxJ3x5S/nqeUq7ZPkAMbGAD4rXHc=", "__NEXT_PREVIEW_MODE_ID": "a73f14461f32143a34336ee6512fa976", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "bbfa7974c59a4eb46461271342202adc12a9341c1aef19e1070e5435808197d5", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5730c734290a78172c1781d25a4bc992283e1a2a9bcd3958bca45d8082df7eb5" } } }, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/favicon.ico/route": "/favicon.ico", "/account/page": "/account", "/b2b/page": "/b2b", "/community/page": "/community", "/bio-shield/page": "/bio-shield", "/checkout/page": "/checkout", "/fair/dashboard/page": "/fair/dashboard", "/impact/page": "/impact", "/mats/page": "/mats", "/fair/page": "/fair", "/cart/page": "/cart", "/page": "/", "/subsidiaries/page": "/subsidiaries", "/verify/[code]/page": "/verify/[code]", "/trust/page": "/trust", "/fair/join/page": "/fair/join", "/login/page": "/login", "/admin/crm/page": "/admin/crm", "/admin/inventory/page": "/admin/inventory", "/admin/orders/page": "/admin/orders", "/admin/page": "/admin", "/admin/fair/page": "/admin/fair", "/admin/analytics/page": "/admin/analytics", "/admin/qr/page": "/admin/qr", "/admin/products/page": "/admin/products", "/admin/production/page": "/admin/production", "/admin/team/page": "/admin/team", "/admin/squads/page": "/admin/squads", "/portal/knowledge/page": "/portal/knowledge", "/portal/requests/page": "/portal/requests", "/portal/tasks/page": "/portal/tasks", "/portal/logistics/page": "/portal/logistics", "/portal/page": "/portal", "/auth/callback/route": "/auth/callback", "/api/setup-db/route": "/api/setup-db", "/store/[slug]/page": "/store/[slug]", "/store/page": "/store" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/auth/callback": {}, "/api/setup-db": {}, "/store/[slug]": {}, "/store": {} } };
