...
const fallbackProducts: Product[] = [
  ...
  { product_id: "4", sku: "BIO-VEG-01", name: "Bio-Shield Matrix - Vegetable", category: "BIO_SHIELD", description: "Short-cycle produce packaging program for freshness and safer transit.", base_price_bdt: 25, minimum_order_quantity: 500, image_url: null, is_active: true },
  { product_id: "5", sku: "BIO-SPICE-01", name: "Bio-Shield Matrix - Raw Spice", category: "BIO_SHIELD", description: "Moisture-managed packaging program for dry goods and spices.", base_price_bdt: 45, minimum_order_quantity: 500, image_url: null, is_active: true },
  { product_id: "6", sku: "BIO-RETORT-V1", name: "Bio-Shield Retort Pouch (1yr)", category: "BIO_SHIELD", description: "High-barrier packaging program for cooked food distribution.", base_price_bdt: 85, minimum_order_quantity: 500, image_url: null, is_active: true },
];
      ...
      <section className="bg-white border-b border-[#031E49]/10 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-[#0A2D6C]/60 text-lg max-w-2xl mx-auto">
            Eco-friendly prayer mats and advanced active packaging solutions for retail and enterprise buyers.
          </p>
        </div>
      </section>
