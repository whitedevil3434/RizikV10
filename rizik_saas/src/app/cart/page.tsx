        ...
        return (
            <div className="min-h-screen bg-[#F5F2EB] flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-[#0A2D6C]/50 mb-6">Browse our products and add items to get started.</p>
                    <Link
                        href="/store"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        {items.map((item) => (
                            <div
                                key={item.sku}
                                className="bg-white rounded-2xl border border-[#031E49]/10 p-6 flex items-center gap-6 shadow-sm"
                            >
                                {/* Product Icon */}
