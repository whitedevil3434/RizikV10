        ...
        <div className="flex flex-col items-center w-full bg-[#F5F2EB] min-h-screen">
            ...
            <section className="relative w-full py-24 flex flex-col items-center justify-center overflow-hidden border-b border-[#031E49]/10 bg-white">
                ...
                <div className="max-w-4xl mx-auto px-4 text-center z-10">
                    <div className="mb-4 text-xs uppercase tracking-[0.14em] font-semibold text-[#031E49]/50">
                        Rizik BioShield by Rizik Global
                    </div>
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#00B16A]/10 border border-[#00B16A]/20 mb-6">
                        <span className="text-xs font-semibold text-[#00B16A]">Advanced Retort and Ambient Shelf-Life Platform</span>
                    </div>
                    ...
                    <p className="text-lg md:text-xl text-[#0A2D6C]/60 max-w-2xl mx-auto leading-relaxed">
                        Active packaging technology designed for safer storage, longer shelf life, and scalable food distribution.
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="relative aspect-square md:aspect-[4/3] w-full rounded-3xl bg-white border border-[#031E49]/10 flex items-center justify-center overflow-hidden group shadow-sm">
                            ...
                            <div className="flex flex-col gap-4 items-center z-10">
                                ...
                                <div className="w-56 h-8 bg-[#00B16A]/20 rounded-lg border border-[#00B16A]/50 flex items-center justify-center text-[#00B16A] text-sm font-bold shadow-[0_0_15px_rgba(0,177,106,0.3)]">Active Barrier Layer</div>
                        ...
                        <div className="flex flex-col gap-8">
                            <div>
                                <h2 className="text-3xl font-bold text-[#031E49] mb-4">Platform Architecture</h2>
                                <p className="text-[#0A2D6C]/60 leading-relaxed">
                                    Bio-Shield is engineered for controlled breathability, stronger handling performance, and improved shelf stability across multiple food categories.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="p-6 rounded-2xl bg-white border border-[#031E49]/10 shadow-sm">
                                    ...
                                    <div className="text-xs text-[#0A2D6C]/50">Fresh produce program</div>
                                </div>
                                ...
                                <div className="p-6 rounded-2xl bg-white border border-[#031E49]/10 shadow-sm">
                                    ...
                                    <div className="text-xs text-[#0A2D6C]/50">Dry goods program</div>
                                </div>
                                ...
                                <div className="p-6 rounded-2xl bg-white border border-[#031E49]/10 sm:col-span-2 ring-2 ring-[#00B16A]/30 bg-[#00B16A]/5 shadow-sm">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <div className="text-xs font-bold px-2 py-1 rounded bg-[#00B16A] text-white uppercase tracking-wider">High Barrier</div>
                                    </div>
                                    <div className="text-sm font-medium text-[#031E49] mb-1">Cooked food distribution program</div>
                                    <div className="text-xs text-[#0A2D6C]/60">Designed for extended ambient handling and high-throughput logistics.</div>
                                </div>
                            </div>
                        </div>
