...
class DynamicForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final submitAction = data[
        'submitAction']; // Expecting { "type": "call_provider", "provider": "...", "method": "..." }
      ...
      children: [
        ...fields.map((fieldData) {
          ...
          final Map<String, dynamic> widgetData = <String, dynamic>{
            'type':
                'input_field', // Default to input_field, but could be others
            'label': fieldData['label'],
            'hint': fieldData['hint'],
            'field_name': fieldData[
                'field_name'], // Used by FormStateManager via label for now, but should be explicit
