...
class WidgetRegistry {
  ...
  static final Map<String, Widget Function(BuildContext, Map<String, dynamic>)>
      registry = {
    ...
    'rizik_vertical_list': (context, data) =>
        _buildColumn(context, data), // Alias for vertical list
    ...
    'single_child_scroll_view': (context, data) =>
        _buildScrollView(context, data),
    // Composable SDUI widgets
    'rizik_trust_aura': (context, data) => WidgetTrustAura(data: data),
    'rizik_expense_summary': (context, data) =>
        WidgetExpenseSummary(data: data),
    ...
    'money_bag': (context, data) =>
        WidgetMoneybagDisplay(data: data), // Alias for SDUI
    'cart_display': (context, data) => WidgetCartDisplay(data: data),
    'cart_summary': (context, data) =>
        WidgetCartDisplay(data: data), // Alias for SDUI
    'unified_wallet_display': (context, data) =>
        WidgetUnifiedWalletDisplay(data: data),
    'trust_score_display': (context, data) =>
        WidgetTrustScoreDisplay(data: data),
    'order_stats_display': (context, data) =>
        WidgetOrderStatsDisplay(data: data),
    'mission_stats_display': (context, data) =>
        WidgetMissionStatsDisplay(data: data),
    'squad_stats_display': (context, data) =>
        WidgetSquadStatsDisplay(data: data),
    'inventory_stats_display': (context, data) =>
        WidgetInventoryStatsDisplay(data: data),
    'shopping_stats_display': (context, data) =>
        WidgetShoppingStatsDisplay(data: data),
    ...
    'order_tracker': (context, data) =>
        WidgetOrderTrackerDisplay(data: data), // Bridge to OrderProvider
    'order_tracker_display': (context, data) =>
        WidgetOrderTrackerDisplay(data: data),
    ...
    'hyperlocal_service_card': (context, data) =>
        HyperlocalServiceCard(data: data),
    ...
    return Card(
      ...
      shape: data['borderRadius'] != null
          ? RoundedRectangleBorder(
              borderRadius:
                  BorderRadius.circular(_parseDouble(data['borderRadius'])!),
            )
          : null,
      child: data['child'] != null
          ? build(context, data['child']['type'], data['child'])
              ...
              ? ListTile(
                  ...
                  leading: data['data']['icon'] != null
                      ? Container(
                          padding: const EdgeInsets.all(8),
                          decoration: BoxDecoration(
                            color: _parseColor(data['data']['iconColor'])
                                    ?.withOpacity(0.1) ??
  ...
  static Future<void> _handleAction(
    ...
    if (type == 'NAVIGATE') {
      ...
      if (providerName == 'RizikDhaarProvider' &&
        ...
        try {
          // Real Provider Call
          await Provider.of<RizikDhaarProvider>(context, listen: false)
  ...
  static Widget _buildStack(BuildContext context, Map<String, dynamic> data) {
    return Stack(
      alignment:
          _parseAlignment(data['alignment']) ?? AlignmentDirectional.topStart,
      children: (data['children'] as List<dynamic>? ?? [])
          .map((childData) => build(context, childData['type'], childData))
          .toList(),
    );
  ...
  static Widget _buildHeroBanner(
      BuildContext context, Map<String, dynamic> data) {
