 ...
 */
function lightReInjectErrors(text, config) {
    if (!text || config.chaosThreshold <= 0)
...
exports.PRECONDITION_SYSTEM_PROMPT = `You are preparing text for non-native academic humanization.
...
const PRESERVE_ERRORS_SYSTEM_PROMPT = (isAcademic) => `You are an academic polisher. Your ONLY job is to improve natural flow and add reflective scholarly depth.
...
exports.PRESERVE_ERRORS_SYSTEM_PROMPT = PRESERVE_ERRORS_SYSTEM_PROMPT;
