    ...
    try {
        for (const block of blocks) {
            ...
            if (!isAssignmentMode && (0, qualityEngine_1.shouldRegenerateByQuality)(qualityCheck)) {
                ...
                let retryOutput = (0, chaosEngine_1.applyStructuralChaos)(paragraphText, `${userDnaSeed}:retry:${pIdx}`, isAcademic);
            ...
            if (!isAssignmentMode) {
                ...
                outputParagraph = fidelityEngine_1.FidelityEngine.aiClichePurge(outputParagraph);
                // [SKIP LLM] Pure Forensic Hull Resin Path
                outputParagraph = (0, chaosEngine_1.applyStructuralChaos)(paragraphText, userDnaSeed + pIdx, isAcademic);
