...
const chaosEngine_1 = require("./src/ghost/chaosEngine");
const humanErrorEngine_1 = require("./src/ghost/humanErrorEngine");
const aiText = `Bangladesh vs India: Strategic Considerations of a Hypothetical Atomic Conflict
Introduction
...
const userDna = "v26_nuclear_bypass_dna";
// V26 Pipeline Simulation (Extreme Mode)
let structuralResult = (0, chaosEngine_1.applyStructuralChaos)(aiText, userDna, true);
let result = (0, humanErrorEngine_1.applyHumanErrors)(structuralResult, {
    chaosThreshold: 20, // Increased threshold for V26
    errorFactor: 1.2, // Increased factor
    isAcademic: true,
    dnaSeed: userDna,
    assignmentMode: true
});
