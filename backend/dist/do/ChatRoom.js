...
export class ChatRoom extends DurableObject {
    ...
    async webSocketMessage(ws, message) {
        ...
        // 1. Store in SQLite
        this.ctx.storage.sql.exec("INSERT INTO messages (id, sender, content, type, created_at) VALUES (?, ?, ?, ?, ?)", crypto.randomUUID(), msg.sender, msg.content, msg.type || 'text', Date.now());
        // 2. Broadcast
