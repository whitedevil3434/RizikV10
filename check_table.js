...
console.log('Starting Supabase MCP server to check table...');
...
function handleMessage(msg) {
    if (msg.id === 1 && step === 0) {
        ...
        if (msg.error) {
            console.error('❌ Failed to check table:', msg.error);
            process.exit(1);
        }
        console.log('✅ Table check result:', JSON.stringify(msg.result));
        process.exit(0);
    }
}
